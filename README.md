...
### 2단계: 프로그램 다운로드 (Git clone)

> 🔒 비공개 저장소이므로 Git + 토큰 인증이 필요합니다.
> 상세 절차는 **[SETUP.md](SETUP.md)** 참조.
...
```
cd /d %USERPROFILE%\Downloads\HPWD-DataManager
python run.py
```
...
> 패키지가 추가됐을 수 있으니 가끔: `pip install -r requirements.txt`
